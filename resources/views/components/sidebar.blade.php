        ...
        <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <button type="button"
                            class="flex items-center w-full p-2 text-base cursor-pointer rounded text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700"
                        ...
                        <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                            <li>
                                <a href=""
                                    class="flex items-center p-2 text-base rounded pl-11 group text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Stacked</a>
                            </li>
                            <li>
                                <a href=""
                                    class="flex items-center p-2 text-base rounded pl-11 text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Sidebar</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                <div>
                    <div class="pt-2 space-y-2">
                        <a href="{{ route('empresas.index') }}"
                            class="flex items-center p-2 text-base cursor-pointer rounded text-gray-700 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">
