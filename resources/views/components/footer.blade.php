<footer class="bottom-0 dark:bg-gray-800 dark:border-gray-700 rounded-base shadow-xs border border-default">
    <div class="w-full mx-auto max-w-7xl p-4 md:flex md:items-center md:justify-between">
        <span class="text-sm text-body sm:text-center">© 2026 <a href="#"
                class="hover:underline">I.A.V.S™</a>. Todos os direitos reservados.
        </span>
